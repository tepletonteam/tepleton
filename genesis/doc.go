...
a standard genesis file to initialize your wrsp application.

We wish to support using one genesis file to initialize both
tepleton and the application, so this file format is designed
to be embedable in the tepleton genesis.json file. We reuse
the same chain_id field for tepleton, ignore the other fields,
and add a special app_options field that contains information just
for the wrsp app (and ignored by tepleton).
...
store and parse options for your wrsp application. The important part is
