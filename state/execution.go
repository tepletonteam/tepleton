...
func validateInputs(accounts map[string]*types.Account, signBytes []byte, ins []types.TxInput) (total int64, res wrsp.Result) {
...
func validateOutputs(outs []types.TxOutput) (total int64, res wrsp.Result) {
	for _, out := range outs {
