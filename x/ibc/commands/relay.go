...
func IBCRelayCmd(cdc *wire.Codec) *cobra.Command {
	...
	cmd.Flags().String(FlagToChainNode, "tcp://localhost:46658", "<host>:<port> to tepleton rpc interface for this chain")
...
// https://github.com/tepleton/tepleton-sdk/blob/master/client/helpers.go using specified address
