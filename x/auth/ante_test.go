...
func checkValidTx(t *testing.T, anteHandler sdk.AnteHandler, ctx sdk.Context, tx sdk.Tx) {
	...
	require.Equal(t, sdk.WRSPCodeOK, result.Code)
...
func checkInvalidTx(t *testing.T, anteHandler sdk.AnteHandler, ctx sdk.Context, tx sdk.Tx, code sdk.CodeType) {
	defer func() {
		if r := recover(); r != nil {
			...
			case sdk.ErrorOutOfGas:
				require.Equal(t, sdk.ToWRSPCode(sdk.CodespaceRoot, code), sdk.ToWRSPCode(sdk.CodespaceRoot, sdk.CodeOutOfGas),
	...
	require.Equal(t, sdk.ToWRSPCode(sdk.CodespaceRoot, code), result.Code,
		fmt.Sprintf("Expected %v, got %v", sdk.ToWRSPCode(sdk.CodespaceRoot, code), result))
}
...
func TestAnteHandlerMemoGas(t *testing.T) {
	...
	tx = newTestTxWithMemo(ctx, []sdk.Msg{msg}, privs, accnums, seqs, fee, "wrspninasidniandsinasindiansdiansdinaisndiasndiadninsd")
	checkInvalidTx(t, anteHandler, ctx, tx, sdk.CodeOutOfGas)

	// memo too large
	fee = NewStdFee(2001, sdk.NewCoin("atom", 0))
	tx = newTestTxWithMemo(ctx, []sdk.Msg{msg}, privs, accnums, seqs, fee, "wrspninasidniandsinasindiansdiansdinaisndiasndiadninsdwrspninasidniandsinasindiansdiansdinaisndiasndiadninsdwrspninasidniandsinasindiansdiansdinaisndiasndiadninsd")
