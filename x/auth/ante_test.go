...
func TestAnteHandlerSigErrors(t *testing.T) {
	...
	ctx := sdk.NewContext(ms, wrsp.Header{ChainID: "mychainid"}, false, nil, log.NewNopLogger(), 100000)
...
func TestAnteHandlerSequences(t *testing.T) {
	...
	mapper := NewAccountMapper(cdc, capKey, &BaseAccount{})
	anteHandler := NewAnteHandler(mapper, BurnFeeHandler)
	ctx := sdk.NewContext(ms, wrsp.Header{ChainID: "mychainid"}, false, nil, log.NewNopLogger(), 1000000)
...
func TestAnteHandlerFees(t *testing.T) {
	...
	mapper := NewAccountMapper(cdc, capKey, &BaseAccount{})
	anteHandler := NewAnteHandler(mapper, BurnFeeHandler)
	ctx := sdk.NewContext(ms, wrsp.Header{ChainID: "mychainid"}, false, nil, log.NewNopLogger(), 10000)
