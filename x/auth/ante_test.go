...
func TestAnteHandlerMemoGas(t *testing.T) {
	...
	tx = newTestTxWithMemo(ctx, msg, privs, accnums, seqs, fee, "wrspninasidniandsinasindiansdiansdinaisndiasndiadninsd")
	checkInvalidTx(t, anteHandler, ctx, tx, sdk.CodeOutOfGas)

	// memo too large
	fee = NewStdFee(2001, sdk.NewCoin("atom", 0))
	tx = newTestTxWithMemo(ctx, msg, privs, accnums, seqs, fee, "wrspninasidniandsinasindiansdiansdinaisndiasndiadninsdwrspninasidniandsinasindiansdiansdinaisndiasndiadninsdwrspninasidniandsinasindiansdiansdinaisndiasndiadninsd")
