...
func TestSetValidator(t *testing.T) {
	...
	require.Equal(t, validator.WRSPValidator(), updates[0])
...
func TestGetTendermintUpdatesAllNone(t *testing.T) {
	...
	assert.Equal(t, validators[0].WRSPValidator(), updates[0])
	assert.Equal(t, validators[1].WRSPValidator(), updates[1])
...
func TestGetTendermintUpdatesSingleValueChange(t *testing.T) {
	...
	require.Equal(t, 1, len(updates))
	require.Equal(t, validators[0].WRSPValidator(), updates[0])
}
...
func TestGetTendermintUpdatesMultipleValueChange(t *testing.T) {
	...
	require.Equal(t, validators[0].WRSPValidator(), updates[0])
	require.Equal(t, validators[1].WRSPValidator(), updates[1])
}
...
func TestGetTendermintUpdatesInserted(t *testing.T) {
	...
	updates := keeper.GetTendermintUpdates(ctx)
	require.Equal(t, 1, len(updates))
	require.Equal(t, validators[2].WRSPValidator(), updates[0])
	...
	updates = keeper.GetTendermintUpdates(ctx)
	require.Equal(t, 1, len(updates))
	require.Equal(t, validators[3].WRSPValidator(), updates[0])
	...
	updates = keeper.GetTendermintUpdates(ctx)
	require.Equal(t, 1, len(updates))
	require.Equal(t, validators[4].WRSPValidator(), updates[0])
}
...
func TestGetTendermintUpdatesNotValidatorCliff(t *testing.T) {
	...
	require.Equal(t, validators[0].WRSPValidatorZero(), updates[0])
	require.Equal(t, validators[2].WRSPValidator(), updates[1])
}
