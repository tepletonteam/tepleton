...
func TestSlashUnbondingDelegation(t *testing.T) {
	...
	ctx = ctx.WithBlockHeader(wrsp.Header{Time: int64(10)})
	keeper.SetUnbondingDelegation(ctx, ubd)
	...
	ctx = ctx.WithBlockHeader(wrsp.Header{Time: int64(0)})
	keeper.SetUnbondingDelegation(ctx, ubd)
	slashAmount = keeper.slashUnbondingDelegation(ctx, ubd, 0, fraction)
...
func TestSlashWithUnbondingDelegation(t *testing.T) {
	...
	// this may not be the desirable behaviour, ref https://github.com/tepleton/tepleton-sdk/issues/1440
	ctx = ctx.WithBlockHeight(13)
	keeper.Slash(ctx, pk, 9, 10, fraction)
	ubd, found = keeper.GetUnbondingDelegation(ctx, addrDels[0], addrVals[0])
	require.True(t, found)
