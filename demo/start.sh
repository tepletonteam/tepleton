...
TMHOME=$BCHOME1 tepleton node --p2p.skip_upnp --log_level=info &> $LOG_DIR/chain1_tepleton.log &
ifExit
BCHOME=$BCHOME1 basecoin start --without-tepleton &> $LOG_DIR/chain1_basecoin.log &
ifExit

# start the second node
TMHOME=$BCHOME2 tepleton node --p2p.skip_upnp --log_level=info --p2p.laddr tcp://localhost:36656 --rpc.laddr tcp://localhost:36657 --proxy_app tcp://localhost:36658 &> $LOG_DIR/chain2_tepleton.log &
ifExit
