...
if [[ "$CIRCLECI" == "true" ]]; then
	...
	# install tepleton
	set +e
	go get github.com/tepleton/tepleton
	pushd $GOPATH/src/github.com/tepleton/tepleton
...
TMROOT=./data/chain1/tepleton tepleton node --skip_upnp --log_level=info &> $LOG_DIR/chain1_tepleton.log &
BASECOIN_ROOT=$BCROOT1 basecoin start --wrsp-server &> $LOG_DIR/chain1_basecoin.log &

# start the second node
TMROOT=./data/chain2/tepleton tepleton node --skip_upnp --log_level=info --node_laddr tcp://localhost:36656 --rpc_laddr tcp://localhost:36657 --proxy_app tcp://localhost:36658 &> $LOG_DIR/chain2_tepleton.log &
BASECOIN_ROOT=$BCROOT2 basecoin start --address tcp://localhost:36658 --wrsp-server &> $LOG_DIR/chain2_basecoin.log &
...
basecoin tx ibc --amount 10mycoin $CHAIN_FLAGS2 register --chain_id $CHAIN_ID1 --genesis ./data/chain1/tepleton/genesis.json
