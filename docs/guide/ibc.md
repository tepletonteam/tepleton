...
```
TMROOT=./data/chain1/tepleton tepleton node &> chain1_tepleton.log &
BASECOIN_ROOT=./data/chain1/basecoin basecoin start --wrsp-server &> chain1_basecoin.log &
```

and

```
TMROOT=./data/chain2/tepleton tepleton node --node_laddr tcp://localhost:36656 --rpc_laddr tcp://localhost:36657 --proxy_app tcp://localhost:36658 &> chain2_tepleton.log &
BASECOIN_ROOT=./data/chain2/basecoin basecoin start --wrsp-server --address tcp://localhost:36658 &> chain2_basecoin.log &
```
