...
BCHOME=./data/chain1/basecoin basecoin start --without-tepleton &> chain1_basecoin.log &
```
...
BCHOME=./data/chain2/basecoin basecoin start --without-tepleton --address tcp://localhost:36658 &> chain2_basecoin.log &
```
