...
```
TMROOT=./data/chain1 tepleton node &> chain1_tepleton.log &
BCHOME=./data/chain1 basecoin start --without-tepleton &> chain1_basecoin.log &
```

and

```
TMROOT=./data/chain2 tepleton node --node_laddr tcp://localhost:36656 --rpc_laddr tcp://localhost:36657 --proxy_app tcp://localhost:36658 &> chain2_tepleton.log &
BCHOME=./data/chain2 basecoin start --without-tepleton --address tcp://localhost:36658 &> chain2_basecoin.log &
```
