...
details, see the [go-wire documentation](https://github.com/tepleton/go-wire/blob/develop).
...
```golang
// File: tepleton-sdk/examples/basecoin/app/init_stores.go
...
// File: tepleton-sdk/x/bank/handler.go
