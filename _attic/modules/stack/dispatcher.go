...
// and, as such, should never be done in the context of an WRSP app.  Only
...
func (d *Dispatcher) InitValidate(log log.Logger, store state.SimpleDB, vals []*wrsp.Validator) {
