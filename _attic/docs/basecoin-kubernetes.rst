...
*Note:* This guide is based from - and has been updated - the `origin Medium article <https://blog.tepleton.network/get-your-cryptocurrency-up-and-running-in-10-minutes-9ae4c703eb1c>`__.
...
`mintnet-kubernetes <https://github.com/tepleton/tools/tree/master/mintnet-kubernetes>`__
...
precautions <https://github.com/tepleton/tools/tree/master/mintnet-kubernetes#security>`__).
If you want to launch an application with many stakeholders, consider
using `our set of
Ansible <https://github.com/tepleton/tools/tree/master/ansible-tepleton>`__
...
::
    ...
    curl -Lo app.yaml https://raw.githubusercontent.com/tepleton/tools/master/mintnet-kubernetes/examples/basecoin/app.yaml
