...
func (app *BasecoinApp) registerMsgs() {
	...
	cdc.RegisterConcrete(bank.SendMsg{}, "tepleton-sdk/SendMsg", nil)   // XXX refactor out
	cdc.RegisterConcrete(bank.IssueMsg{}, "tepleton-sdk/IssueMsg", nil) // XXX refactor out to bank/msgs.go
	// more msgs here...
