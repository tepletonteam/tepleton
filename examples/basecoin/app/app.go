...
// BasecoinApp implements an extended WRSP application. It contains a BaseApp,
...
// by the application.
func (app *BasecoinApp) BeginBlocker(_ sdk.Context, _ wrsp.RequestBeginBlock) wrsp.ResponseBeginBlock {
	return wrsp.ResponseBeginBlock{}
}

// EndBlocker reflects logic to run after all TXs are processed by the
// application.
func (app *BasecoinApp) EndBlocker(_ sdk.Context, _ wrsp.RequestEndBlock) wrsp.ResponseEndBlock {
...
func (app *BasecoinApp) initChainer(ctx sdk.Context, req wrsp.RequestInitChain) wrsp.ResponseInitChain {
	...
	if err != nil {
		// TODO: https://github.com/tepleton/tepleton-sdk/issues/468
		panic(err)
	}
