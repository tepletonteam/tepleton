...
- `chain-id` is the unique ID that helps tepleton identify which network to connect to. You can find it in the terminal output from the tond daemon in the header block , or in the genesis.json file  at `~/.basecoind/config/gensis.json`
