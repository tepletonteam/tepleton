...
cd go/src/github.com/tepleton/tepleton-sdk
EOF

    mkdir -p /home/ubuntu/go/bin
    mkdir -p /home/ubuntu/go/src/github.com/tepleton
    ln -s /vagrant /home/ubuntu/go/src/github.com/tepleton/tepleton-sdk

    chown -R ubuntu:ubuntu /home/ubuntu/go
    chown ubuntu:ubuntu /home/ubuntu/.bash_profile

    su - ubuntu -c 'cd /home/ubuntu/go/src/github.com/tepleton/tepleton-sdk && make get_tools'
  SHELL
end
