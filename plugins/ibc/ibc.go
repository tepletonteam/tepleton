...
// func (p DataPayload) ValidateBasic() wrsp.Result {
// 	return wrsp.OK
// }
...
// func (p CoinsPayload) ValidateBasic() wrsp.Result {
// 	// TODO: validate
// 	return wrsp.OK
// }
...
// func (ibc *IBCPlugin) RunTx(store state.KVStore, ctx types.CallContext, txBytes []byte) (res wrsp.Result) {
// 	// Decode tx
// 	var tx IBCTx
...
// 	if err != nil {
// 		sm.res = wrsp.ErrInternalError.AppendLog(cmn.Fmt("Loading ChainState: %v", err.Error()))
// 		return
// 	}
// 	if !exists {
// 		sm.res = wrsp.ErrInternalError.AppendLog(cmn.Fmt("Missing ChainState"))
// 		return
// 	}
...
// 	if err != nil {
// 		sm.res = wrsp.ErrInternalError.AppendLog(cmn.Fmt("Loading Header: %v", err.Error()))
// 		return
// 	}
// 	if !exists {
...
// func (ibc *IBCPlugin) InitChain(store state.KVStore, vals []*wrsp.Validator) {
// }

// func (cp *IBCPlugin) BeginBlock(store state.KVStore, hash []byte, header *wrsp.Header) {
// }

// func (cp *IBCPlugin) EndBlock(store state.KVStore, height uint64) (res wrsp.ResponseEndBlock) {
// 	return
// }
