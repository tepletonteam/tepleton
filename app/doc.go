...
data storage functionality and act as a bridge between the wrsp
...
(check/deliver/commit), and provides bindings to the WRSP interface
for functionality such as handshaking with tepleton on restart,
